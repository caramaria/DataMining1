...
\end{table}
To ensure that the model is not overfitted, the learned model was applied to the FIFA17 data set. After selecting and renaming the attributes an accuracy of 87,06 \% was scored.  %As performance measures the weighted recall of 88,19 \% and weighted precision of 88,20 \% should be mentioned.
